...
> train = mconcat . Prelude.map bigramFreqMap . Prelude.map words . lines

list of list words
Prelude.map words (lines "a b \n c d")
...
WORKS
foo = prelude.map words . lines
foo "a b \n c d"
[["a","b"],["c","d"]]

words "a b c a"
bigrams (words "a b c a")

bigramFreqMap (words "a b c a")

apply bigramfre maps to each line
Prelude.map bigramFreqMap . Prelude.map words . lines
